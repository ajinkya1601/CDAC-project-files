...
-- select * from user;
 ...
 insert into clinic (clinic_name, clinic_email, clinic_address, clinic_phone, morning_time,
					afternoon_time, evening_time, user_username)
values ("My clinic", "myclinic@gmail.com", "Pune","5452569863", "9am to 1pm", "2pm to 5pm", "6pm to 9pm", "ajinkya123"),
...
'21-02-25', "Manager", 2),
("Vaibhav", "Deshmukh", "4563298752", "male", "vaibhav.deshmukh@gmail.com", '1980-01-31', "Pune", 30000,
'21-02-15', "HOD", 3),
("Sarita", "Hatwar", "4563298752", "female", "vaibhav.deshmukh@gmail.com", '1980-01-31', "Pune", 30000,
'21-02-15', "HOD", 1);
...
insert into patient(first_name, last_name, age, mobile, email, address, gender, dept_id, employee_id)
 values ("Aditya", "Hatwar", 27, "2563269854", "aditya@gmail.com", "Nagpur", "Male", 1, 1),
		("Prasad", "Bandawar", 26, "5563269854", "prasad@gmail.com", "Chandrapur", "Male", 2,2);
